...
// Plugin
class plgCCK_FieldJs_Date_Time_Picker extends JCckPluginField
{
	protected static $type		=	'js_date_time_picker';
	...
	public function onCCK_FieldPrepareForm( &$field, $value = '', &$config = array(), $inherit = array(), $return = false )
	{
		...
		$form	=	'<input type="datetime-local" id="'.$id.'" name="'.$name.'" value="'.$value.'" '.$attr.' />';
